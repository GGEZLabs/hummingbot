...
class VolumePumperMarketConfig(BaseModel):
    ...
    @property
    def support_at_static(self) -> bool:
        """Check if flexible support is at the static support boundary."""
        return self.flexible_support == self.static_support

    @property
    def resistance_at_static(self) -> bool:
        """Check if flexible resistance is at the static resistance boundary."""
        return self.flexible_resistance == self.static_resistance
