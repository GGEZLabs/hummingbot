...
class UzxSpotCandles(CandlesBase):
    ...
    def candles_url(self):
        return self.rest_url + CONSTANTS.CANDLES_ENDPOINT.format(symbol=self._trading_pair)
    ...
    def _parse_websocket_message(self, data: dict):
        ...
        candles_row_dict = {}
        if (
            data is not None and "data" in data and data["data"] is not None
